                        ...
                        <div class="table-responsive">
                            <table id="basic-btn" class="table mb-0">
                                ...
                                <tbody>
                                    @foreach ($data as $row)
                                        @php
                                            $count = Application::where('school',$row->school)->count();
                                        @endphp
                                        <tr>
                                            ...
                                            <td class="table-action">
                                                <button type="button" class="btn btn-icon btn-outline-primary viewData" data-toggle="modal" data-target="#update" value="{{ $row->school }}"><i class="feather icon-eye"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
