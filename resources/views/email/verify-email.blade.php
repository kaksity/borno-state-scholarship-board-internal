                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <h1>Hi {{ $fullName }},</h1>
                                            <p>You recently requested to verify your account. Click on the link below to reset it. <strong>This account verification link is only valid
                                                    for the next 30 minutes.</strong></p>
                                            <!-- Action -->
